        ...
        Column(
            ...
            LazyColumn(
                ...
                items(state.shops) { shop ->
                    HardwareShopCard(
                        shop = shop,
                        onCallClick = { onEvent(HardwareShopsEvent.CallClick("1234567890")) })
                }
            }
        }
    }
...
fun HardwareShopsTopBar(onBackClick: () -> Unit, availableCount: Int) {
    Box(
        ...
        Column(
            ...
            Text(
                text = "Hardware Shops", style = MaterialTheme.typography.titleLarge.copy(
    ...
    Card(
        ...
        Column(
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                ...
                Text(
                    text = "Items Available:", style = MaterialTheme.typography.bodyMedium.copy(
